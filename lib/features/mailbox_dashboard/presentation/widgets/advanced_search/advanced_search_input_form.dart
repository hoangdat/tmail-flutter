...
class AdvancedSearchInputForm extends GetWidget<AdvancedFilterController> {
  ...
  Widget build(BuildContext context) {
    ...
    // Single Consumer for the whole form: mailbox/date/sort fields read straight
    // from the committed SSOT. The from/to and label subtrees stay on Obx because
    // they are backed by GetX state (tag lists, expand mode, staged label).
    return Consumer(
          ...
          child: Column(
            children: [
              ...
              AdvancedSearchFieldWidget(
                ...
                child: DefaultButtonArrowDownFieldWithTabKeyWidget(
                  text: filter.mailbox?.getFolderNameForQuickSearch(appLocalizations) ?? appLocalizations.allEmail,
              ...
              AdvancedSearchFieldWidget(
                ...
                child: DefaultDateDropDownFieldWidget(
                  imagePaths: controller.imagePaths,
              ...
              AdvancedSearchFieldWidget(
                ...
                child: SortByDropDownButton(
                  imagePaths: controller.imagePaths,
                  sortOrderSelected: filter.sortOrderType,
