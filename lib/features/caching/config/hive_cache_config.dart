...
import 'package:tmail_ui_user/features/base/upgradeable/upgrade_hive_database_steps_v23.dart';
...
class HiveCacheConfig {
  ...
  Future<void> onUpgradeDatabase(CachingManager cachingManager) async {
    ...
    await UpgradeHiveDatabaseStepsV23(cachingManager).onUpgrade(oldVersion, newVersion);
